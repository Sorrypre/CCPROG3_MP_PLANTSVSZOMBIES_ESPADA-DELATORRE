...
public class Map {
    ...
    public void addNormalZombie(int row, Map map){
        ...
        System.out.println("Created a zombie at Row " + row);
    ...
    public void placeSunFlower(int row, int col, int gamePhaseTime, Counter sunCounter){
        ...
        System.out.println("Sunflower is at: " + "[ " + row + " , " + col + " ]");
    ...
    /** This method adds a Peashooter object to the ArrayList indicating that a Peashooter Plant exists on the lawn
     @param map the Map object where it will be spawned
     @param row the row which the plant will be planted
     @param col the column which the plant will be planted
     @param gamePhaseTime the current time indicating how long the game has been running
     @param sunCounter the accumulated value of sun
    ...
    public void placePeashooter(Map map, int row, int col, int gamePhaseTime, Counter sunCounter){
        ...
        System.out.println("Peashooter is at: " + "[ " + row + " , " + col + " ]");
    ...
    /** This method returns the Zombie object closest the house in a certain row.
     @param rowPosition the scaled row position of Zombie
     @param colPosition the scaled column position of Zombie
     @return min the closest Zombie in distance
     */
    ...
    /** This method returns the Zombie object closest the house in a certain row.
     @param rowPosition the scaled row position of Zombie
     @return true if Zombie is in the parameter rowPosition, false otherwise
     */
